...
CREATE TABLE IF NOT EXISTS posts (
    ...
    -- Listas separadas por coma (ej. "golang, seguridad"). Se guardan como
    -- texto plano en vez de array nativo de Postgres para simplificar el
    -- manejo desde Go y el futuro formulario del panel de admin.
...
INSERT INTO posts (title, slug, excerpt, content, tags, categories, published)
VALUES
  (
